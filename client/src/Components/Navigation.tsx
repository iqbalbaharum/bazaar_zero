  ...
  return (
    <Navbar>
      <NavbarGroup align={Alignment.LEFT}>
        ...
        <NavbarDivider />
        Sequence <span style={{marginLeft: 4, marginRight: 4}}>:</span> {account ? account : <Button intent="primary" text="Login" onClick={onHandleSequenceWallet} /> }
        <NavbarDivider />
        Polygon <span style={{marginLeft: 4, marginRight: 4}}>:</span> {ethers.account ? ethers.account : <Button intent="primary" text="Connect Metamask" onClick={() => ethers.activateBrowserWallet()} /> }
        <NavbarDivider />
